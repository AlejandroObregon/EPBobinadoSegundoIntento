...
namespace Web.Pages.DiagnosticoTecnico
{
    public class EliminarModel : PageModel
    {
        ...
        public DiagnosticoTecnicoResponse Diagnostico { get; set; } = default!;
        ...
        public async Task OnGetAsync(int id)
        {
            ...
            string endpoint = _config.ObtenerMetodo("ApiEndPointsDiagnosticoTecnico", "ObtenerPorId");
            using var client = new HttpClient();
            var respuesta = await client.GetAsync(string.Format(endpoint, id));
            if (!respuesta.IsSuccessStatusCode) return;

            var opciones = new JsonSerializerOptions { PropertyNameCaseInsensitive = true };
            Diagnostico = JsonSerializer.Deserialize<DiagnosticoTecnicoResponse>(
        ...
        public async Task<IActionResult> OnPostEliminarAsync(int id)
        {
            ...
            string endpoint = _config.ObtenerMetodo("ApiEndPointsDiagnosticoTecnico", "Eliminar");
            using var client = new HttpClient();
