...
namespace Web.Pages.Producto
{
    public class ListadoModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            // Construye endpoint "Obtener" (todos los productos)
            ...
            if (response.IsSuccessStatusCode && response.StatusCode == HttpStatusCode.OK)
            {
                ...
                Productos = JsonSerializer.Deserialize<List<ProductoResponse>>(json, opciones) ?? new();
            }
            ...
            {
                ModelState.AddModelError(string.Empty, "No se pudieron obtener los productos.");
            }
