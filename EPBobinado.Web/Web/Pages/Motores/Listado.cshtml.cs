...
namespace Web.Pages.Motores
{
    public class ListadoModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "No se encontró la configuración de endpoints de Motor.");
                return Page();
            }
            ...
            if (response.IsSuccessStatusCode && response.StatusCode == HttpStatusCode.OK)
            {
                ...
                Motores = JsonSerializer.Deserialize<List<MotorResponse>>(json, opciones) ?? new();
            }
            ...
            {
                ModelState.AddModelError(string.Empty, "No se pudieron obtener los motores.");
            }
